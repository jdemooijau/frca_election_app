...
Optional flags:
  ...
  --blank-rate F     probability of a blank vote per office (default: 0.0)
"""
...
def _simulate_voter_inner(base_url, code, candidate_weights, weights_lock, blank_rate):
    ...
    for office in offices:
        ...
        # Most realistic voters use every available slot. A tiny fraction
        ...
        count = max_sel if random.random() < 0.99 else random.randint(1, max_sel)
