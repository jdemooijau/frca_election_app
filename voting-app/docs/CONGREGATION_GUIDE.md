...
1. **Sign the attendance register at the door.** This count is needed to work out the threshold of votes required for a candidate to be elected (Articles 6 and 7).
2. **Receive one voting card.** After the chairman has opened the election, the task team hands out a dual-sided card. One side is a paper ballot; the other side is a code slip for voting on your phone.
3. **Choose which side to use.** You can vote on paper or on your phone — whichever you prefer. If you don't have a phone with you, you can borrow one from another brother — your code slip is the only thing that identifies your vote, so the phone you use does not matter. See below.
...
![Enter your code](../../screenshots/13_voter_enter_code.png)
...
![Projector display](../../screenshots/21_projector_display.png)
...
- Come to church; sign the register at the door.
- Once the chairman has opened the election, the task team hands you a voting card.
- Vote on your phone or on paper — your choice. If you don't have a phone, borrow one from another brother.
